...
function score = tune_objective(p)
    ...
    if nargin < 1
        % Default parameter vector: [Q11, Q22, R, obs_factor, k_servo]
        p = [100, 0.3, 0.2, 2, 10];
    end
    ...
    controller.custom_k_servo = k_servo;            % update servo gain
    ...
    fprintf('Parameters: Q11=%.2f, Q22=%.2f, R=%.2f, obs_factor=%.2f, k_servo=%.2f, Score=%.4f\n',...
            Q11, Q22, R, obs_factor, k_servo, score);
end
