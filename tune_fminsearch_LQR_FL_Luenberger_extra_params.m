...
[opt_params, best_score] = fminsearch(@tune_objective_LQR_FL_Luenberger_extra_params, p0, options);

fprintf('Optimal Parameters: Q=[%.2f, %.2f, %.2f, %.2f], R=%.2f, obs_factor=%.2f, nl_scale=%.2f\n',...
    opt_params(1), opt_params(2), opt_params(3), opt_params(4), opt_params(5), opt_params(6), opt_params(7));
fprintf('Best Score: %.4f\n', best_score);

// Parameters: Q=[440.12, 0.14, 0.00, 0.00], R=0.23, obs_factor=1.94, nl_scale=0.68, Score=3.1790
